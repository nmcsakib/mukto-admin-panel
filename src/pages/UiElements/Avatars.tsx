...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="Admin Panel Avatars Dashboard | TailAdmin - Admin Panel Admin Dashboard Template"
        description="This is Admin Panel Avatars Dashboard page for TailAdmin - Admin Panel Tailwind CSS Admin Dashboard Template"
      />
