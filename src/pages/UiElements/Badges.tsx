...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="Admin Panel Badges Dashboard | TailAdmin - Admin Panel Admin Dashboard Template"
        description="This is Admin Panel Badges Dashboard page for TailAdmin - Admin Panel Tailwind CSS Admin Dashboard Template"
      />
