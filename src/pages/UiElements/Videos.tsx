...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="Admin Panel Videos Tabs | TailAdmin - Admin Panel Admin Dashboard Template"
        description="This is Admin Panel Videos page for TailAdmin - Admin Panel Tailwind CSS Admin Dashboard Template"
      />
